export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-6 md:bottom-8 right-6 md:right-8 z-50 flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#25D366] hover:bg-[#20BA5A] transition-all duration-300 hover:scale-110"
      style={{
