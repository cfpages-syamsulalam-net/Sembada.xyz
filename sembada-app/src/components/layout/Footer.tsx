...
const socialLinks = [
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-[#f2ca50]">
  ...
  {
    name: 'WhatsApp',
    url: 'https://wa.me/6282325886660',
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-[#f2ca50]">
            ...
            <ul className="space-y-3 text-sm text-[#64748B] mb-6">
              ...
              <li className="flex items-start gap-2">
                ...
                <div className="flex flex-col gap-1">
                  <a href="tel:+6282325886660" className="hover:text-[#f2ca50] transition-colors">
                    0823 2588 6660
                  </a>
